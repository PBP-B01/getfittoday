...
urlpatterns = [
    ...
    path('edit/<int:pk>/', views.edit_community, name='edit_community'),
    ...
    path('api/communities/', views.communities_json, name='communities_json'), 
    path('api/community/<int:pk>/', views.community_detail_json, name='community_detail_json'), 
    path('api/create/', views.create_community_flutter, name='create_community_flutter'), 
    path('api/edit/<int:community_id>/', views.edit_community_flutter, name='edit_community_flutter'), 
    path('api/fitness-spots/', views.get_fitness_spots_json, name='get_fitness_spots_json'), 
